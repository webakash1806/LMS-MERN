            ...
            <div className='flex items-center justify-center h-[90vh] '>
                <div
                    ...
                    <div className='flex items-center w-fit justify-between  p-2 gap-3 pr-5 rounded-lg left-0 rounded-b-none text-[1.1rem]'>
                        <BsHouseFill onClick={() => navigate('/')} className='text-[#000000] cursor-pointer text-[1.3rem] absolute left-4' />
                    ...
                    <div className='h-[21rem] bg-[#1A202A] mx-5 p-3 w-[15rem] flex flex-col items-center justify-around rounded-md rounded-b-none'>
                        ...
                        <button onClick={() => navigate('/course')} className='bg-[#FF6700] hover:bg-[#ff4d00] p-2 text-[1.1rem]  rounded-md w-full font-semibold tracking-wide'>Go back to courses</button>
                    </div>
